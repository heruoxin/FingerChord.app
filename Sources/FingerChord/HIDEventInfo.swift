...
enum HIDEventInfo {
    private static let cg = dlopen("/System/Library/Frameworks/CoreGraphics.framework/CoreGraphics", RTLD_NOW)
    private static let io = dlopen("/System/Library/Frameworks/IOKit.framework/IOKit", RTLD_NOW)
    private static let copyEvent: (@convention(c) (CGEvent) -> Unmanaged<CFTypeRef>?)? = symbol(cg, "CGEventCopyIOHIDEvent")
    private static let getSender: (@convention(c) (CFTypeRef) -> UInt64)? = symbol(io, "IOHIDEventGetSenderID")
